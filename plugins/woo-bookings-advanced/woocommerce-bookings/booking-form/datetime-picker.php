...
<fieldset class="wc-bookings-date-picker <?php echo implode( ' ', $class ); ?>">
    <legend>
        <span class="label"><?php echo $label; ?>:</span> <small class="label wc-bookings-date-picker-choose-date"><?php _e( 'Choose...', 'woocommerce-bookings' ); ?></small>
    </legend>
...
<div class="form-field form-field-wide">
    <label class="label" for="<?php echo $name; ?>"><?php _e( 'Time', 'woocommerce-bookings' ); ?>:</label>
