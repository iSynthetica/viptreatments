<?php
/**
 * Functions for extending or changing woocommerce plugin
 */
...
add_action( 'woocommerce_checkout_before_customer_details', 'vip_add_custom_email_field' );
/**
 * Add email field before all columns
 */
function vip_add_custom_email_field($checkout) {
    echo '<div id="my_custom_email_field">';
    echo    '<h3>' . __('Contact email', 'kloe') . '</h3>';

            woocommerce_form_field( 'billing_email', array(
                'type'          => 'text',
                'required'      => true,
                'class'         => array('my-field-class form-row-wide'),
                'label'         => __('Email <small>(this field is required)</small>', 'kloe'),
                'placeholder'   => __('Enter your contact email', 'kloe'),
...
/**
 * Add field for selecting type of payment for bookings checkout
 *
 * @param $checkout
 */
